...
{
    public partial class frmHT_CrmTid_CapNhatPhienBanMoi : DevExpress.XtraEditors.XtraForm
    {
        private readonly string sPath;

        private bool success;

        public frmHT_CrmTid_CapNhatPhienBanMoi()
        {
            InitializeComponent();
        ...
        private void bteUpdatePack_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                openFileDialog.Filter = "CrmTidPackage|CrmTidPackage.exe";
        ...
        private void Upgrade()
        {
            try
            {
                ...
                foreach (var file in Directory.GetFiles(sPath, "*@FRT*.exe"))
                {
                    ...
                    var request = (FtpWebRequest)GtidWebRequest.CreateA("osp4q3rUgFY9M1hI/+3PKto5NAX+QGMdngpHhEi9qOA=", fileInfo.Name);
                ...
                CrmTidVer.Instance.UpToVersion(commingVersion);
        ...
        private void frmHT_CrmTid_CapNhatPhienBanMoi_FormClosed(object sender, FormClosedEventArgs e)
        {
